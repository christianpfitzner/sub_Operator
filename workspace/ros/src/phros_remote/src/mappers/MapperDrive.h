...
{
public:
  MapperDrive(ros::NodeHandle& nh, MapperController::ButtonActions* btnActions, MapperController::AxisActions* axisActions);
  virtual ~MapperDrive();
...
//  ros::Publisher _pubSensorHead;
  ...
  ros::ServiceClient _flipper_preset_service; 

  MapperController::ButtonActions* _btnActions;
  MapperController::AxisActions* _axisActions;
};
