...
public:
  ...
  std::shared_ptr<std_msgs::String> confData(void){return _subSyscmd.data();}
  void clearSysCmdData(void){_subSyscmd.clearData();}
...
private:
  ...
  SuperSubscriber<std_msgs::String> _subSyscmd;
