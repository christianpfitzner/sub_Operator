...
EnumErrorDevice SerialCom::receive(unsigned char& receiveData)
{
    ...
    {
        std::cerr << "boost::exeption in redeive(data): " << error.what() << std::endl;
        std::cerr << "will continue..." << std::endl;
								    ...
								    unsigned int delay_us )
{
    ...
    {
        std::cerr << "boost::exeption in redeive(data,delay): " << error.what() << std::endl;
        std::cerr << "will continue..." << std::endl;
