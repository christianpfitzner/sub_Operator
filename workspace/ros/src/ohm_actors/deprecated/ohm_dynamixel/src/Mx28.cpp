...
Mx28::Mx28(const int id, DynamixelBus* bus)
: Dynamixel(MX28, id, bus)
{
    if (!_bus)
        return;
...
bool Mx28::setSpeed(const float speed)
{
    if (!_bus)
    {
        MSG("no set bus.");
...
bool Mx28::setTorque(const float torque)
{
    if (!_bus)
    {
        MSG("no set bus.");
...
bool Mx28::setAngle(const float angle)
{
    if (!_bus)
    {
        MSG("no set bus.");
...
bool Mx28::setMinimumPosition(const uint16_t position)
{
    if (!_bus)
    {
        MSG("no set bus.");
...
bool Mx28::setMaximumPosition(const uint16_t position)
{
    if (!_bus)
    {
        MSG("no set bus.");
