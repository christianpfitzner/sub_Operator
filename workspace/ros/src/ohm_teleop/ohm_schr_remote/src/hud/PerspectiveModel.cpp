...
{
  _model[static_cast<unsigned int>(Points::CHASS_LOW_FRONT_LEFT )] = Eigen::Vector4d( 1.5,  1.5, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_LOW_FRONT_RIGHT)] = Eigen::Vector4d( 1.5, -1.5, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_LOW_REAR_LEFT  )] = Eigen::Vector4d(-1.5,  1.5, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_LOW_REAR_RIGHT )] = Eigen::Vector4d(-1.5, -1.5, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_TOP_FRONT_LEFT )] = Eigen::Vector4d( 1.5,  1.5, 0.5, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_TOP_FRONT_RIGHT)] = Eigen::Vector4d( 1.5, -1.5, 0.5, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_TOP_REAR_LEFT  )] = Eigen::Vector4d(-1.5,  1.5, 0.5, 1.0);
  _model[static_cast<unsigned int>(Points::CHASS_TOP_REAR_RIGHT )] = Eigen::Vector4d(-1.5, -1.5, 0.5, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_B0_L)]            = Eigen::Vector4d( 0.1,  0.0, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_B1_L)]            = Eigen::Vector4d(-0.1,  0.0, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_B0_R)]            = Eigen::Vector4d( 0.1,  0.4, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_B1_R)]            = Eigen::Vector4d(-0.1,  0.4, 0.0, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_T_L)]             = Eigen::Vector4d( 0.0,  0.0, 1.0, 1.0);
  _model[static_cast<unsigned int>(Points::FLIPP_T_R)]             = Eigen::Vector4d( 0.0,  0.4, 1.0, 1.0);
}
