#ifndef MAXONDIFFERENTIALDRIVE_H_
#define MAXONDIFFERENTIALDRIVE_H_
...
/**
 * @class Main class for differential-drive robot platform
 * @author Stefan May
 * @date 13.11.2014
 */
class MaxonDifferentialDrive
{
public:
